...
//#define _32KHZ    // Schaltfrequenz  -- die gew�nschte einkommentieren

//#define FDD6637_IRLR7843  1  // bessere MosFet best�ckt? bewirkt h�here Stromgrenzen  
...
#define ADR1   0x40    // f�r Motoradresswahl
#define ADR2   0x80    // 
